...
with a real version range (see [Version Ranges](./version-range.md)).

---

## See also

- [Creating Packages](../getting-started/creating-packages.md) — the full spec format,
  including the [dependencies](../getting-started/creating-packages.md#dependencies) section.
- [Version Range](./version-range.md) — the dependency version range syntax.

    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "AI Agent Integration", link: "/getting-started/ai-integration" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "info", link: "/commands/info-command" },
          ...
          { text: "scan", link: "/commands/scan-command" },
          ...
          { text: "trust", link: "/commands/trust-command" },
